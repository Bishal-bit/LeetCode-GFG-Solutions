# [Uncommon characters](https://www.geeksforgeeks.org/problems/uncommon-characters4932/1?page=2&category=Strings&sortBy=submissions)
## Easy
...
Constraints:1&lt;= s1.size(), s2.size() &lt;= 105Both strings contain only lowercase English letters.